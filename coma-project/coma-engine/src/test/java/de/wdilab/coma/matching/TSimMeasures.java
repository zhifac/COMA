...
public class TSimMeasures extends TestCase {
	...
	float[][][] simValues = {
			...
			{{0.5f,0.5f,0.5f,0.5f,	0.45833334f,0.5f,0.5f,0}, {0,0,0}},
			{{0.5714286f,0.5714286f,0.5714286f,0.5714286f,	0.8055556f,0.6666666f,0.6666666f,0},{0,0,0}},
			{{0.65384614f,0.6086956f,0.6086956f,0.6086956f,	 0.8259259f,0.7f,0.7f,0},{0.5f,0.5f,0.33333334f}},
			{{0.8f,0.44444445f, 0.7407407f,0.44444445f,	0.5760684f,0.15384614f,0.15384614f,0},{0.8164966f,0.8164966f,0.6666667f}},
	};
